...
tmp<volScalarField>
kOmegaSSTPANS<MomentumTransportModel, BasicMomentumTransportModel>::kOmegaSSTPANS::F1
(
...
) const
{
    ...
    (
        ...
        (
            ...
            (4*alphaOmega2_*(fOmega_/fK_))*k_/(CDkOmegaPlus*sqr(y_))
        ),
        scalar(10)
    );
...
template<class MomentumTransportModel, class BasicMomentumTransportModel>
tmp<volScalarField>
kOmegaSSTPANS<MomentumTransportModel, BasicMomentumTransportModel>::kOmegaSSTPANS::
F2() const
{
...
template<class MomentumTransportModel, class BasicMomentumTransportModel>
void kOmegaSSTPANS<MomentumTransportModel, BasicMomentumTransportModel>::correctNut
(
...
template<class MomentumTransportModel, class BasicMomentumTransportModel>
void kOmegaSSTPANS<MomentumTransportModel, BasicMomentumTransportModel>::
correctNut()
{
    correctNut(2*magSqr(symm(fvc::grad(this->U_))), F2());
}


template<class MomentumTransportModel, class BasicMomentumTransportModel>
tmp<volScalarField::Internal>
kOmegaSSTPANS<MomentumTransportModel, BasicMomentumTransportModel>::Pk
(
...
template<class MomentumTransportModel, class BasicMomentumTransportModel>
tmp<volScalarField::Internal>
kOmegaSSTPANS<MomentumTransportModel, BasicMomentumTransportModel>::epsilonByk
(
...
template<class MomentumTransportModel, class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
kOmegaSSTPANS<MomentumTransportModel, BasicMomentumTransportModel>::
omegaSource() const
{
    return tmp<fvScalarMatrix>
    (
...
template<class MomentumTransportModel, class BasicMomentumTransportModel>
tmp<fvScalarMatrix>
kOmegaSSTPANS<MomentumTransportModel, BasicMomentumTransportModel>::Qsas
(
...
:
    ...
    (
        ...
        this->mesh_,
        dimensionedScalar("fK", dimless, 1.0)
    ),
    ...
    (
        ...
        this->mesh_,
        dimensionedScalar("fEps", dimless, 1.0)
    ),
...
template<class MomentumTransportModel, class BasicMomentumTransportModel>
bool kOmegaSSTPANS<MomentumTransportModel, BasicMomentumTransportModel>::read()
{
...
void kOmegaSSTPANS<MomentumTransportModel, BasicMomentumTransportModel>::correct()
{
    ...
    (
        (2*alphaOmega2_*(fOmega_/fK_))*(fvc::grad(k_) & fvc::grad(omega_))/omega_
    );
    ...
    // Info << F2 << endl;
    {
        ...
        volScalarField::Internal betaPrime((gamma*betaStar_) - (gamma*betaStar_/fOmega_) + (beta/fOmega_));
        ...
        (
         ...
         ==
          ...
          - fvm::Sp(alpha()*rho()*betaPrime*omega_(), omega_)
          - fvm::SuSp
            (
    ...
    (
     ...
     ==
      ...
      - fvm::Sp(alpha()*rho()*epsilonByk(F1, F2), k_)
      + kSource()
