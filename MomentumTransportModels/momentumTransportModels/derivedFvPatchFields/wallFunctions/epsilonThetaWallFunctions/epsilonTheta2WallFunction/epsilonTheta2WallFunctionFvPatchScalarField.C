...
#include "epsilonTheta2WallFunctionFvPatchScalarField.H"
...
Foam::scalar Foam::epsilonTheta2WallFunctionFvPatchScalarField::tolerance_ = 1e-5;

// * * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * //

void Foam::epsilonTheta2WallFunctionFvPatchScalarField::setMaster()
{
    if (master_ != -1)
    {
        return;
    ...
    forAll(bf, patchi)
    {
        if (isA<epsilonTheta2WallFunctionFvPatchScalarField>(bf[patchi]))
        {
            epsilonTheta2WallFunctionFvPatchScalarField& epf = epsilonThetaPatch(patchi);
...
void Foam::epsilonTheta2WallFunctionFvPatchScalarField::createAveragingWeights()
{
    const volScalarField& epsilonTheta =
        static_cast<const volScalarField&>(this->internalField());
...
Foam::epsilonTheta2WallFunctionFvPatchScalarField&
Foam::epsilonTheta2WallFunctionFvPatchScalarField::epsilonThetaPatch(const label patchi)
{
    const volScalarField& epsilonTheta =
        static_cast<const volScalarField&>(this->internalField());
    ...
    const epsilonTheta2WallFunctionFvPatchScalarField& epf =
        refCast<const epsilonTheta2WallFunctionFvPatchScalarField>(bf[patchi]);

    return const_cast<epsilonTheta2WallFunctionFvPatchScalarField&>(epf);
}


void Foam::epsilonTheta2WallFunctionFvPatchScalarField::calculateTurbulenceFields
(
...
{
    // Accumulate all of the G, GTheta and epsilonTheta contributions
...
void Foam::epsilonTheta2WallFunctionFvPatchScalarField::calculate
(
...
)
{
    ...
    // Set epsilonTheta and G and GTheta
...
Foam::epsilonTheta2WallFunctionFvPatchScalarField::
epsilonTheta2WallFunctionFvPatchScalarField
(
    const fvPatch& p,
...
epsilonTheta2WallFunctionFvPatchScalarField
(
    const epsilonTheta2WallFunctionFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
epsilonTheta2WallFunctionFvPatchScalarField
(
    const epsilonTheta2WallFunctionFvPatchScalarField& ewfpsf,
    const DimensionedField<scalar, volMesh>& iF
)
:
...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
Foam::scalarField& Foam::epsilonTheta2WallFunctionFvPatchScalarField::G(bool init)
{
...
Foam::scalarField& Foam::epsilonTheta2WallFunctionFvPatchScalarField::GTheta(bool init)
{
    if (patch().index() == master_)
    {
        if (init)
...
Foam::scalarField& Foam::epsilonTheta2WallFunctionFvPatchScalarField::epsilonTheta
(
    bool init
)
{
...
void Foam::epsilonTheta2WallFunctionFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::epsilonTheta2WallFunctionFvPatchScalarField::updateWeightedCoeffs
(
...
void Foam::epsilonTheta2WallFunctionFvPatchScalarField::manipulateMatrix
(
