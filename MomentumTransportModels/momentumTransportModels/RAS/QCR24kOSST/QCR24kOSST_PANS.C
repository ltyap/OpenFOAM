...
void QCR24kOSST_PANS<BasicMomentumTransportModel>::correctNonlinearStress
(const volTensorField& gradU)
{
    ...
    this->nonlinearStress_ = Cr1_*twoSymm(Wbar&R)
                                + Cr2_*this->nut_*dev(innerSqr(S))/magGradU;
}
...
template<class BasicMomentumTransportModel>
QCR24kOSST_PANS<BasicMomentumTransportModel>::QCR24kOSST_PANS
(
...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
template<class BasicMomentumTransportModel>
bool QCR24kOSST_PANS<BasicMomentumTransportModel>::read()
{
...
template<class BasicMomentumTransportModel>
void QCR24kOSST_PANS<BasicMomentumTransportModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
...

    {
        ...
        volScalarField::Internal betaPrime(
                                            (gamma*this->betaStar_) 
