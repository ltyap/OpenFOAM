...
tmp<volScalarField> AKNPANS<BasicMomentumTransportModel>::yStar() const
{
    return pow(this->nu()*epsilon_, 0.25)*y_/this->nu();
}

template<class BasicMomentumTransportModel>
tmp<volScalarField> AKNPANS<BasicMomentumTransportModel>::Rt() const
{
    return sqr(k_)/(this->nu()*epsilon_);
}

template<class BasicMomentumTransportModel>
tmp<volScalarField> AKNPANS<BasicMomentumTransportModel>::fMu() const
{
...
template<class BasicMomentumTransportModel>
tmp<volScalarField> AKNPANS<BasicMomentumTransportModel>::fEps2() const
{
...
template<class BasicMomentumTransportModel>
void AKNPANS<BasicMomentumTransportModel>::correctNut()
{
...
template<class BasicMomentumTransportModel>
AKNPANS<BasicMomentumTransportModel>::AKNPANS
(
...
template<class BasicMomentumTransportModel>
bool AKNPANS<BasicMomentumTransportModel>::read()
{
...
template<class BasicMomentumTransportModel>
void AKNPANS<BasicMomentumTransportModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
