...
void QCRkOSST<BasicMomentumTransportModel>::correctNonlinearStress
...
template<class BasicMomentumTransportModel>
QCRkOSST<BasicMomentumTransportModel>::QCRkOSST
(
...
template<class BasicMomentumTransportModel>
void QCRkOSST<BasicMomentumTransportModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
